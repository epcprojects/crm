...
<body bgcolor="#F3F4F6">
    <table bgcolor="#F3F4F6" width="100%" class="full-width" border="0" align="center" cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td bgcolor="#F3F4F6" style="padding:24px; background-color:#F3F4F6;">
                    ...
                    ">
                            ...
                            text-decoration:none;
                        ">
                                                    <img src="${appUrl}/images/Banners/HarperLogoIcon.svg" width="30"
                                                        alt="" style="
                                display:block;
                                width:30px;
                                height:auto;
