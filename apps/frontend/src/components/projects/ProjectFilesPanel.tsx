      ...
      <div className="flex flex-col gap-3 rounded-2xl md:flex-row md:items-center md:justify-between">
        <div className="relative flex w-full items-center md:max-w-xs">
          <input
            ...
            placeholder="Search..."
            className="h-10.5 w-full rounded-lg border border-gray-200 bg-white pe-3 ps-9 text-sm text-gray-900 outline-none placeholder:text-gray-400"
          />
      ...
      <div className="flex max-h-[calc(100dvh-360px)] min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-gray-200 bg-white sm:rounded-2xl">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          {files.map((file) => (
            <div
              key={file.id}
              className="border-b border-gray-200 px-3 py-4 last:border-b-0 sm:px-4"
            >
                ...
                <div className="flex min-w-0 items-start gap-3 sm:items-center sm:gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <p
                      ...
                      className="w-full cursor-pointer truncate text-sm font-semibold leading-[1.2] text-gray-900"
                    >
                      {file.name}
                    </p>
