...
export const mockNotifications: NotificationItem[] = [
  ...
  },
  {
    ...
    message:
      'replied on ticket #TK-88 (Login page broken): "I updated the auth headers..."',
    timeLabel: '2m ago',
    unread: true,
    kind: 'update',
  ...
  },
  {
    ...
    message:
      'created ticket #TK-118 (Checkout page is not loading) in Acme Corp.',
    timeLabel: '45m ago',
    unread: false,
    kind: 'update',
    categories: ['tickets'],
  },
  {
    ...
    message: 'changed ticket #TK-104 status from Open to In Progress.',
    timeLabel: '1h ago',
    unread: false,
    kind: 'update',
  ...
  },
  {
    ...
    message: 'changed ticket #TK-104 priority from Medium to High.',
    timeLabel: '1h ago',
    unread: false,
    kind: 'update',
    categories: ['tickets'],
  },
  {
    ...
    message: 'replied on ticket #TK-88 (Login page broken).',
    timeLabel: '2h ago',
    unread: true,
    kind: 'message',
    categories: ['tickets', 'messages'],
  },
  {
    ...
    message: 'assigned ticket #TK-126 (Invoice export fails) to you.',
    timeLabel: '3h ago',
    unread: false,
    kind: 'update',
