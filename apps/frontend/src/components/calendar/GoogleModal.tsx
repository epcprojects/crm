...
export default function GoogleModal({
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-box google-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="google-setup">
            <div className="setup-steps">
              ...
              <ol className="step-list">
                <li className="step-item">
                  ...
                  <div className="step-body">
                    ...
                    <p>Go to <a href="https://console.cloud.google.com" target="_blank" rel="noreferrer" className="ext-link">console.cloud.google.com</a> and create a new project or select an existing one.</p>
                  </div>
                </li>
                ...
                <li className="step-item">
                  ...
                  <div className="step-body">
                    ...
                    <p>Navigate to <em>APIs & Services → Library</em>, search for "Google Calendar API" and enable it.</p>
                  </div>
                </li>
                ...
                <li className="step-item">
                  ...
                  <div className="step-body">
                    ...
                    <p>Go to <em>APIs & Services → Credentials → Create Credentials → OAuth 2.0 Client ID</em>.</p>
                    <p>Set application type to <em>Web application</em> and add this redirect URI:</p>
                    <code className="code-block">http://localhost:3000/api/auth/google/callback</code>
                  </div>
                </li>
                ...
                <li className="step-item">
                  ...
                  <div className="step-body">
                    ...
                    <p>Run <code>npm run dev</code> after adding environment variables.</p>
                  </div>
                </li>
              </ol>
              ...
              <div className="scopes-info">
                ...
                <ul>
                  <li><code>calendar.readonly</code> — Read your calendar events</li>
                  <li><code>calendar.events</code> — Create and delete events</li>
                </ul>
              </div>
            </div>
            ...
            <div className="modal-footer">
              ...
              <button className="btn-submit google-connect-btn" onClick={onConnect}>
